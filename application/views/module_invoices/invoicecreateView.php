		...
		<div class=" container-fluid   container-fixed-lg bg-gray">
			<div class="row justify-content-center">
				...
				<div id="section_filters" class="col-md-3">
					<div class="card m-t-10">
						<div class="card-header  separator bg-light">
							...
							<button id="apply" name="apply" class='pull-right btn btn-primary' value="apply">Fetch</button>
						</div>
						<div class="card-body">
							<!--<form role="form"> -->
							...
							<div class="form-group" id="invoice_date_div">
								...
								<input type="date" id="invoice_date" name="invoice_date" onkeydown="return false" value="<?php echo date('Y-m-d'); ?>" class="form-control" tabindex="1">
							</div>
							<div class="form-group" id="invoice_date_f_div">
								<label>To Date</label>
								<!--<span class="help">e.g. "2019-08-23"</span>-->
								<input type="date" id="invoice_date_f" name="invoice_date_f" onkeydown="return false" value="<?php echo date('Y-m-d'); ?>" class="form-control" tabindex="2">
							</div>
							...
							<div class="form-group hide" id="origin_div">
								...
								<select multiple class="form-control allow-multi-select" id="origin" name="origin" tabindex="3">
							...
							<div class="form-group hide" id="destination_div">
								...
								<select multiple class="form-control allow-multi-select" id="destination" name="destination" tabindex="3">
							...
							<div class="form-group" id="customer_div">
								...
								<select multiple class="form-control allow-multi-select" id="customer" name="customer" tabindex="3">
				...
				<div id="section_optionals" class="col-md-2 hide" disabled>
					<div class="card m-t-10">
						<div class="card-header  separator bg-light">
							<button id="cancel" name="cancel" class='pull-left btn btn-danger' value="cancel">Back</button>
							<button id="save" name="save" class='pull-right btn btn-success' value="save">Save</button>
						</div>
						<div class="card-header  separator bg-secondary text-white" style="text-align: center;">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="number" min="0" name="fuel_amount" id="fuel_amount" class="form-control" tabindex="7">
							</div>

							<div class="form-group">
								<label>Discount Amount </label>
								<!-- <span class="help">if any (Optional)</span> -->
								<input type="number" min="0" name="discount_amount" id="discount_amount" class="form-control" tabindex="8">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<!--<span class="help">if any (Optional)</span>-->
								<input type="number" min="0" name="other_amount" id="other_amount" class="form-control" tabindex="6">
							</div>
							<div class="form-group">
								<label>Remark</label>
								<!-- <span class="help">if any (Optional)</span> -->
								<textarea name="remark" id="remark" class="form-control" maxlength="256" tabindex="9" rows="6"></textarea>
							</div>
