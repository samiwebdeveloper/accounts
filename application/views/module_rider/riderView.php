                ...
                <div class="card m-t-10">
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive m-t-10">
                      <table style="border-top:1px solid black;" class="table table-bordered" id="myTable">
                        <thead>
                          <th>Sr</th>
                          <th>Rider Code</th>
                          <th>Rider Name</th>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group-attached" style="border-color: black">
                ...
                <div class="form-group form-group-default " id="rider_cnic_div">
                  <label>Rider Employee Code</label>
                  <input type="number" class="form-control" placeholder="Rider Employee Code" name="rider_empcode" id="rider_empcode" tabindex="3">
                </div>
              </div>
            </div>
            <!-- Modal footer -->
        ...
        function add_rider() {
          ...
          if (check != "Fail") {
            var mydata = {
              name: name,
              cnic: cnic,
              rider_empcode: $("#rider_empcode").val()
            };
            $.ajax({
